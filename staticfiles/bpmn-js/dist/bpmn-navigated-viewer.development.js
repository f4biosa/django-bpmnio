/*!
 * bpmn-js - bpmn-navigated-viewer v16.1.0
 *
...
(function (global, factory) {
   ...
   * in bpmn_files. Can be easily replaced with a more sophisticated
   * solution.
   *
   * @example
   *
  ...
  *
  ...
  /**
   * Hook into `import.render.start` and create new planes for bpmn_files with
   ...
   *
   * @return {ModdleElement[]} new bpmn_files created for the collapsed subprocesses
   */
  ...
  Canvas.prototype.viewbox = function(box) {
    ...
    if (!box) {
      ...
      // bpmn_files active layer. This allows us to exclude
  ...
  /**
   * Returns all bpmn_files in the same hierarchy as the requested diagram.
   * Includes all parent and sub process bpmn_files.
   *
   * @param {ModdleElement} definitions
   * @param {ModdleElement} bpmnDiagram
   *
  ...
  function getDiagramsToImport(definitions, bpmnDiagram) {
    ...
    // all collaboration processes can contain sub-bpmn_files
    if (collaboration) {
    ...
    // if we have multiple bpmn_files referencing the same element, we
  ...
  /**
   * A base viewer for BPMN 2.0 bpmn_files.
   *
  ...
  /**
   * A viewer for BPMN 2.0 bpmn_files.
   *
